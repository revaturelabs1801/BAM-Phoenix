...
public class TopicLogger {
	 ...
	 * @throws Throwable 
	 */
	@Around("execution (* com.revature.bam.controller.TopicController.*(..))")
	public void classNameAndTime(ProceedingJoinPoint pjp) throws Throwable {
		...
		System.out.print(" -- TopicController -- ");
	...
	@Before("execution (* com.revature.bam.controller.TopicController.*(..))")
	public void beforeMethod(JoinPoint jp) {
		System.out.println("Before " + jp.getSignature().getName() + " method.");
	}
	
	@After("execution (* com.revature.bam.controller.TopicController.*(..))")
