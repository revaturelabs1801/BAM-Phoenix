...
public class UserLogger {
	 ...
	 * @throws Throwable 
	 */
	@Around("execution (* com.revature.bam.controller.UserController.*(..))")
	...
	@Before("execution (* com.revature.bam.controller.UserController.*(..))")
	public void beforeMethod(JoinPoint jp) {
		System.out.println("Before " + jp.getSignature().getName() + " method.");
	}
	
	@After("execution (* com.revature.bam.controller.UserController.*(..))")
