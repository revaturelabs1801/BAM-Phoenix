...
//	 * @throws Throwable 
//	 */
//	@Around("execution (* com.revature.bam.controller.CalendarController.*(..))")
...
//		System.out.print(" -- CalendarController-- ");
//		
...
//	}
//	
//	@Before("execution (* com.revature.bam.controller.CalendarController.*(..))")
//	public void beforeMethod(JoinPoint jp) {
//		System.out.println("Before " + jp.getSignature().getName() + " method.");
//	}
//	
//	@After("execution (* com.revature.bam.controller.CalendarController.*(..))")
