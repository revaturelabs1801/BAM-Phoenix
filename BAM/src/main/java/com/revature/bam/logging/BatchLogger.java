 ...
 * Logs Classes and Methods related to Batches
 */
@Aspect
@Component
public class BatchLogger {
	 ...
	 * @throws Throwable 
	 */
	@Around("execution (* com.revature.bam.controller.BatchController.*(..))")
	public void classNameAndTime(ProceedingJoinPoint pjp) throws Throwable {
		...
		System.out.print(" -- BatchController -- ");
	...
	@Before("execution (* com.revature.bam.controller.BatchController.*(..))")
	public void beforeMethod(JoinPoint jp) {
		System.out.println("Before " + jp.getSignature().getName() + " method.");
	}
	
	@After("execution (* com.revature.bam.controller.BatchController.*(..))")
